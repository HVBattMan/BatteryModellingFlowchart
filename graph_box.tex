...
\begin{tikzpicture}
	...
	\node [
		...
		(SPMeCC)
		at ($(2plusbar1D.north -| single_particle)!0.1!(2plusbar1D -| single_particle)$) {};
	\node [
		modelpoint,
	...
	% Results
	\node [axisbox, fill=white, draw,line width=3mm, below left = 5cm and -1cm of particle_distribution, anchor=north west, minimum width=54.5cm,minimum height=14cm]
		(2D_results) {\hspace{1.5em} \includegraphics{figures/V_SPMeCC} \includegraphics{figures/V_2D} \includegraphics{figures/T_2D}};
	% \node [profile_pic] (tino_2D) at (2D_results.south west)
	% 	{\includegraphics[width=\PPWIDTH, height=\PPHEIGHT]{images/portraits/sulzer.jpg}};		
	% \node [profile_pic] (scott_2D) at (tino_2D.north west)
	% 	{\includegraphics[width=\PPWIDTH, height=\PPHEIGHT]{images/portraits/ScottMarquis.png}};
	% \node [profile_pic] (rob_2D) at (scott_2D.north west)	
	% 	{\includegraphics[width=\PPWIDTH, height=\PPHEIGHT]{images/portraits/rtimms_photo.jpg}};
	...
	% \node [profile_pic, anchor = south east] (rob_SPM) at (SPM_results.south east)
	% 	{\includegraphics[width=\PPWIDTH, height=\PPHEIGHT]{images/portraits/rtimms_photo.jpg}};
	% 	\node [profile_pic, anchor = south east] (scott_SPM) at (rob_SPM.south west)
	% 	{\includegraphics[width=\PPWIDTH, height=\PPHEIGHT]{images/portraits/ScottMarquis.png}};
	...
	\node [
		...
		(MPM) at ($(SPM)!0.5!(DPM)$) {};
	% Results
	\node [axisbox, fill=white, draw,line width=3mm, anchor=north west, minimum width=33cm,minimum height=16cm] (distributed_results)
	...
	% 	{\includegraphics[width=\PPWIDTH, height=\PPHEIGHT]{images/portraits/tobykirk_photo.jpg}};
	...
	\node [axisbox, fill=white, draw,line width=3mm, right = 3cm of distributed_results.south east, anchor=south west,minimum width=18cm,minimum height=43cm] (fast_results) {};
	% lead-acid
	\node [anchor=north west] (lead_acid_title)
		at (fast_results.north west) {\small Lead-acid};
	% \node [profile_pic, anchor=north east] (tino_fast) at (fast_results.north east)
	% 	{\includegraphics[width=\PPWIDTH, height=\PPHEIGHT]{images/portraits/sulzer.jpg}};
	\picbox{images/portraits/sulzer.jpg}{tino_fast}{fast_results.north east}{north east}
	\node [anchor=north] (lead_acid_voltages)
		at (lead_acid_title.south -| fast_results.north)
		{\includegraphics[width=16cm]{figures/V_T_ODEs_DFN}};
	\node [anchor=north] (lead_acid_concentration)
		at (lead_acid_voltages.south)
		{\includegraphics[width=16cm]{figures/V_T_ODEs_DFN}};
	\draw [line width=1mm]
		(lead_acid_concentration.south -| fast_results.west)
		-- (lead_acid_concentration.south -| fast_results.east);
	%lifp
	\node [anchor=north west] (lifp_title)
		at (lead_acid_concentration.south -| fast_results.west) {\small LiFP};
	\node [anchor=south] at (fast_results.south)
		{\includegraphics[width=16cm]{figures/V_T_ODEs_DFN}};
		\picbox{images/portraits/hennessy_photo.jpeg}{matt_fast}{lead_acid_concentration.south -| fast_results.east}{north east}
	% \node [profile_pic, anchor=north east] (matt_fast) at 
	% 	(lead_acid_concentration.south -| fast_results.east)
	% 	{\includegraphics[width=\PPWIDTH, height=\PPHEIGHT]{images/portraits/hennessy_photo.jpeg}};
	% Arrows
